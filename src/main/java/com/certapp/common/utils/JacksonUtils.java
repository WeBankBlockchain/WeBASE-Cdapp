...
public class JacksonUtils {
    ...
    public static Map<String, Object> toMap(Object value, Supplier<Map<String, Object>> defaultSupplier) {
        ...
        try {
            ...
            log.error("OnError:fail to convert" + toJSONString(value), e);
        }
    ...
    public static List<Object> toList(String value, Supplier<List<Object>> defaultSuppler) {
        ...
        try {
            ...
            log.error("OnError:toList exception\n" + value, e);
        }
        return defaultSuppler.get();
    }
    ...
    public static JsonNode stringToJsonNode(String str) {
        try {
            ...
            log.error("OnError:Parse String to JsonNode error : {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> String objToString(T obj) {
        ...
        try {
            ...
            log.error("OnError:Parse Object to String error : {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T stringToObj(String str, Class<T> clazz) {
        ...
        try {
            ...
            log.error("OnError:Parse String to Object error : {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T stringToObj(String str, TypeReference<T> typeReference) {
        ...
        try {
            ...
            log.error("OnError:Parse String to Object error", e);
            return null;
        }
    }
