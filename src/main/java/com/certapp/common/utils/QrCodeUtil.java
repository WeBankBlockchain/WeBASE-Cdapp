...
public class QrCodeUtil {
    ...
    // 二维码宽度像素pixels数量
    private static final int QRCODE_WIDTH = 174;
    // 二维码高度像素pixels数量
    private static final int QRCODE_HEIGHT = 174;
    // LOGO宽度像素pixels数量
    ...
    private static BufferedImage createImage(String content, String logoPath) throws Exception {
        ...
        BitMatrix bitMatrix = new MultiFormatWriter().encode(content, BarcodeFormat.QR_CODE,
                QRCODE_WIDTH, QRCODE_HEIGHT, hints);
    ...
    public static String save(String content, String logoPath, String destPath) throws Exception {
        log.info("qrCode save. content:{} logoPath:{} destPath:{}", content, logoPath, destPath);
    ...
    public static void encode(String content, String logoPath, OutputStream output)
            throws Exception {
        log.info("qrCode encode. content:{} logoPath:{}", content, logoPath);
        BufferedImage image = QrCodeUtil.createImage(content, logoPath);
    ...
    public static String decode(String path) throws Exception {
        log.info("qrCode decode. path:{}", path);
